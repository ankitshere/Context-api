...
//             <h2 className="text-3xl font-bold mb-4">Share Your Taste 😋</h2>
...
const CreateRecipe = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-10">
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-8 md:p-10 lg:p-12">
          ...
          >
            ...
            <button
              type="submit"
              className="mt-4 sm:mt-6 bg-gradient-to-r from-orange-500 to-red-500 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition duration-300 text-sm sm:text-base"
            >
              Create Recipe
            </button>
          </form>
        ...
        {/* RIGHT SIDE BANNER */}
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white p-8 sm:p-10 lg:p-10 order-first lg:order-last">
          <div className="text-center">
