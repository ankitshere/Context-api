...
const Home = () => {
  ...
  return (
    <div>
      <div className="min-h-screen flex flex-col items-center mt-6 sm:mt-10 px-4">

        {/* Main Card Container */}
        <div className="w-full bg-[#f4eee6] rounded-2xl shadow-xl relative overflow-hidden">

          {/* Floating images — visible only on md+ */}
          <img
            src="https://images.unsplash.com/photo-1604908176997-125f25cc6f3d"
            alt="food"
            className="hidden md:block absolute left-8 top-30 w-28 lg:w-32
              -rotate-12 rounded-2xl shadow-lg
              transition-all duration-500 ease-in-out
              hover:scale-110 hover:-rotate-6 hover:-translate-y-2 hover:shadow-2xl cursor-pointer"
          />
          <img
            src="https://images.unsplash.com/photo-1550547660-d9450f859349"
            alt="food"
            className="hidden md:block absolute right-12 top-110 w-28 lg:w-32
              rotate-30 rounded-2xl shadow-lg
              transition-all duration-500 ease-in-out
              hover:scale-110 hover:rotate-25 hover:-translate-y-2 hover:shadow-2xl cursor-pointer"
          />
          ...
          {/* Hero Section */}
          <div className="text-center m-5 py-8 sm:py-12">
            <div className="text-orange-500 self-center flex flex-col items-center mb-3">
              <ChefHat size={60} strokeWidth={1.25} />
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight px-2">
              Turn Your Ideas into Delicious <br className="hidden sm:block" /> Recipes.
            </h1>

            <p className="mt-5 text-gray-600 max-w-xl mb-8 sm:mb-10 mx-auto text-sm sm:text-base px-2">
              Create, organize, and showcase your favorite recipes with ease. Your
              personal{" "}
              <span className="text-orange-600 font-medium">digital kitchen</span>{" "}
              starts here...
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
              <Link
                to="/CreateRecipe"
                className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-full font-semibold shadow-md transition text-center"
              >
                Create Recipe →
              </Link>
              <button
                ...
                className="w-full sm:w-auto border border-orange-500 text-orange-500 px-8 py-3 rounded-full font-semibold hover:bg-orange-500 hover:text-white transition"
              >
                Explore Recipes →
              </button>
            </div>
        ...
        {/* Food Banner Image */}
        <div className="w-full h-48 sm:h-64 md:h-80 lg:h-[400px] mt-10 sm:mt-16 lg:mt-20 rounded-2xl overflow-hidden">
          <img
        ...
        {/* Features Section */}
        <div className="w-full px-4 sm:px-6 md:px-16 mt-12 sm:mt-16 lg:mt-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 text-center hover:scale-105 hover:shadow-xl transition duration-300">
              <div className="text-2xl sm:text-3xl mb-3">🍳</div>
              <h3 className="font-semibold text-sm sm:text-lg">Create Recipes</h3>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 text-center hover:scale-105 hover:shadow-xl transition duration-300">
              <div className="text-2xl sm:text-3xl mb-3">📚</div>
              <h3 className="font-semibold text-sm sm:text-lg">Manage Recipes</h3>
              <p className="text-gray-500 text-xs sm:text-sm mt-2">
                Organize and edit your recipes anytime
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 text-center hover:scale-105 hover:shadow-xl transition duration-300">
              <div className="text-2xl sm:text-3xl mb-3">🌎</div>
              <h3 className="font-semibold text-sm sm:text-lg">Share Ideas</h3>
              <p className="text-gray-500 text-xs sm:text-sm mt-2">
                Share your cooking ideas with others
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 text-center hover:scale-105 hover:shadow-xl transition duration-300">
              <div className="text-2xl sm:text-3xl mb-3">🔍</div>
              <h3 className="font-semibold text-sm sm:text-lg">Explore Recipes</h3>
              <p className="text-gray-500 text-xs sm:text-sm mt-2">
                Discover new dishes from different cuisines
              </p>
            </div>
      ...
      {/* Footer */}
      <div className="w-full mt-12 sm:mt-16 lg:mt-20 bg-[#f4eee6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16 py-10 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">

            {/* Logo */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">RecipeHub</h2>
              <p className="mt-3 text-sm text-gray-600">
                Your personal digital cookbook. Create, manage and share your recipes with ease.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 text-sm sm:text-base">
                ...
                <li className="hover:text-orange-500 cursor-pointer transition">Recipes</li>
                <li className="hover:text-orange-500 cursor-pointer transition">Create Recipe</li>
              </ul>
            </div>
          ...
          {/* Bottom */}
          <div className="border-t border-gray-300 mt-8 sm:mt-10 pt-5 sm:pt-6 text-center text-xs sm:text-sm text-gray-500">
            © 2026 RecipeHub. All rights reserved.
          </div>
        </div>
      </div>
